      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className={`${ui.card} p-5 lg:col-span-1`}>
          ...
          {contact.unsubscribed_at && (
            <p className="mt-4 text-xs font-medium text-red-700 dark:text-red-300 bg-red-50 dark:bg-red-900/20 rounded-lg px-3 py-2">
              Dado de baja de emails de marketing desde el{' '}
              {new Date(contact.unsubscribed_at).toLocaleDateString('es-ES')}
            </p>
          )}
