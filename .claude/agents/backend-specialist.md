...
description: "Especialista en lógica de negocio, APIs, y arquitectura backend. Usa este agente para Server Actions, API Routes, integraciones con servicios externos, y validaciones. SOLO invocar a petición del usuario, o pidiendo permiso explícito ANTES de delegar."
model: sonnet
