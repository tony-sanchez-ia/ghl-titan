---
name: supabase-admin
description: "Especialista en operaciones de Supabase: base de datos, auth, storage, y RLS. Usa este agente para queries SQL, migraciones, políticas de seguridad, y configuración de auth. SOLO invocar a petición del usuario, o pidiendo permiso explícito ANTES de delegar."
model: sonnet
