...
description: "Especialista en UI/UX, componentes React, Tailwind CSS, y optimización de frontend. Usa este agente para crear interfaces, componentes, y resolver problemas de styling. SOLO invocar a petición del usuario, o pidiendo permiso explícito ANTES de delegar."
model: sonnet
