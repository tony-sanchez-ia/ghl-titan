...
| `n8n-*` (suite, 7 skills) | Interconexion con n8n: workflows, nodos, expresiones, validacion, Code nodes |
...
```
.claude/
├── agents/                    # 7 subagentes (delegacion SOLO con permiso del usuario)
...
│
├── skills/                    # Skills 2.0 (V4) - 27 skills
...
│   ├── easypanel-deploy/     # Deploy VPS con EasyPanel (Docker)
│   ├── n8n-mcp-tools-expert/ # Suite n8n: uso correcto de n8n-mcp
│   ├── n8n-workflow-patterns/ # Suite n8n: patrones de workflows
│   ├── n8n-node-configuration/ # Suite n8n: configuracion de nodos
│   ├── n8n-expression-syntax/ # Suite n8n: expresiones {{}}
│   ├── n8n-validation-expert/ # Suite n8n: errores de validacion
│   ├── n8n-code-javascript/  # Suite n8n: Code nodes JS
│   ├── n8n-code-python/      # Suite n8n: Code nodes Python
...
*Titan Factory V4: Todo es un Skill. Hot reload. Auto-discovery. Zero config.*
